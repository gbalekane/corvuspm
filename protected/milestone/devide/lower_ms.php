...
<th style="color:white" bgcolor="#666699">ID</th>                       
                        ...
                        <th style="color:white"  bgcolor= "#666699">Milestone Type</th>
...
Milestone Type: <input style="width:70%" ></div>
...
<div style=" margin-top:10px; width:95%;background-color:#666699; padding:5px; color:white; text-align:center" >Description and objectives</div>
<div><textarea style="width:95%;margin-right:20px; margin-top:10px;  height:250px; overflow:auto;  background-color:#CCCCFF; color: #666699; text-align:left"></textarea>
</div>
<div style="width:95%; margin-top:10px;background-color:#666699; padding:5px; color:white; text-align:center" >Assignment</div>
...
<div style="width:100%">
<div style="height: 20px;padding:5px; width:95%; float:left">
Parent Activity: <input style="width:50%" ></div>

<div style="height: 20px;padding:5px; width:30%; float:left;margin-top:5px">

Status: <input style="width:100%;" ></div>
<div style="height: 20px;padding:5px; width:30% ;float:left;margin-top:5px">
Responsible: <input style="width:100%;" >
</div>

</div>
<div style="width:95%;background-color:#666699;float:right; margin-top:20px; margin-right:20px; color:white; text-align:center; padding:5px">Result</div>

<div style="width:100%">
<div><textarea style="width:95%;margin-right:20px; margin-top:10px;  height:100px; overflow:auto;  background-color:#CCCCFF; color: #666699; text-align:left"></textarea>
...
<div style="height: 20px;padding:5px; width:95%; float:left; margin-top:10px">
Planning: <input style="width:50%" ></div>
